		...
		generated.NewExecutableSchema(
			generated.Config{
				...
				Directives: generated.DirectiveRoot{
					ListAction: func(ctx context.Context, obj interface{}, next graphql.Resolver, resource string, action generated.XgenResourceListActionType, route *string, pagination *bool, sort []*generated.XgenSortInput, schemaFieldName *string) (res interface{}, err error) {
						return next(ctx)
					},
